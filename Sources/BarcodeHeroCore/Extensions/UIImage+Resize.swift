// Copyright © 2021 SpotHero, Inc. All rights reserved.
    ...
    public extension UIImage {
        ...
        func bh_resizedTo(_ imageView: UIImageView) throws -> UIImage? {
            return try self.bh_resizedTo(imageView.bounds.size, forContentMode: imageView.contentMode)
        }
        
        func bh_resizedTo(_ size: CGSize, forContentMode contentMode: UIView.ContentMode? = nil) throws -> UIImage? {
